  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-semibold text-gray-800">Your Activity Streak</h3>
      ...
      <div className="flex items-center mt-4 text-sm text-gray-600">
        ...
        <div className="w-3 h-3 bg-gray-200 rounded-sm mx-1"></div>
        <div className="w-3 h-3 bg-green-300 rounded-sm mx-1"></div>
